...
(function($) {
  ...
  $.fn.approach = function(styles, distance, callback) {
    ...
    this.each(function(i, obj) {
      ...
      var proxStyles = [],
          colorStyles = ['height', 'boxShadow', '-webkit-box-shadow', '-mozBoxShadow', 'backgroundColor', 'borderBottomColor', 'borderLeftColor', 'borderRightColor', 'borderTopColor', 'color', 'outlineColor'];
